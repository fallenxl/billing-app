...
export const Icon = {
    ...
    Support: ({ className }: { className?: string }) => (
        <svg xmlns="http://www.w3.org/2000/svg" className={cn(Icon.defaultClassname, className)} viewBox="-4 0 64 64">

...
import {  Loader2, MoreHorizontal, RefreshCcw, Settings, Trash } from "lucide-react";
        ...
        <Card className={`overflow-hidden transition-all relative hover:shadow-md`}>
            ...
            <CardHeader className="p-4 pb-0">
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <CardTitle className="text-base">{site.label || site.name}</CardTitle>
            ...
            <CardFooter className="border-t bg-muted/50 p-3 relative w-full">
                ...
                <Badge className="w-auto "  variant={"outline"} >
                    ...
                    <Button variant="ghost" className="ml-auto" size="sm" onClick={() => router.push(`/customer/${customer.id.id}/site/${site.id}`)}>
                        View
                    </Button>
                </div>
            </CardFooter>

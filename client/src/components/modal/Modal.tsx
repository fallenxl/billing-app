...
export function Modal({setIsOpen, title, children}: ModalProps){
    return <>
        <div className="fixed top-0 left-0 w-screen h-screen bg-[rgba(255,255,255,0.7)] bg-opacity-50 flex items-center justify-center z-[101]">
            <div className="bg-white w-full max-w-screen-sm rounded-md border shadow-md h-full sm:h-auto">
